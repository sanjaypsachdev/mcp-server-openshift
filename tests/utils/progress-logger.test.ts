...
import { ProgressLogger, createProgressLogger, createLegacyProgressLogger } from '../../src/utils/progress-logger.js';
...
describe('ProgressLogger', () => {
  ...
  describe('utility methods', () => {
    ...
    it('should add resource verification messages', () => {
      ...
      expect(entries[1].level).toBe('SUCCESS');
      expect(entries[2].message).toBe('❌ Resource service/missing-svc verification failed: Service not found');
