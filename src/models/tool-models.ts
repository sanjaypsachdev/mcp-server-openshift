...
export const OcExposeSchema = z.object({
  resourceType: z
    ...
    .describe('Resource type to expose (service, deploymentconfig, deployment)'),
  ...
  wildcardPolicy: z
    ...
    .optional()
    .default('None')
    .describe('Wildcard policy for the route'),
  tlsTermination: z
    .enum(['edge', 'passthrough', 'reencrypt'])
    .optional()
    .describe('TLS termination type (deprecated, use routeType instead)'),
